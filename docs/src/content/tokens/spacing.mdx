...
The registered `@property --pl-radius-control` (default `0.5rem`) drives
interactive control corners globally.
...
| `--pl-radius-control` | `<length>` | `0.5rem` | Control corner radius                    |
