...
<div class="l-app-shell">
  <!-- Sticky Header -->
  <header class="l-app-shell__topbar c-card" style="border-radius: 0; border-inline: 0;">
    <div class="l-cluster" style="--l-cluster-justify: space-between; padding: var(--pl-space-3);">
      <strong>Logo</strong>
      <div class="l-cluster">
  ...
  <!-- Sidebar Rail -->
  <aside class="l-app-shell__sidebar" style="background: var(--pl-color-surface-2); border-inline-end: 1px solid var(--pl-color-border);">
    <nav class="l-stack" style="--l-stack-gap: var(--pl-space-1); padding: var(--pl-space-3);">
  ...
  <main class="l-app-shell__main" style="padding-block: var(--pl-space-6);">
    <div class="l-container l-stack" style="--l-stack-gap: var(--pl-space-6);">
      ...
      <div class="l-sidebar" style="--l-sidebar-size: 20rem;">
        ...
        <div class="c-card">
          <div class="c-card__header"><h3 class="c-card__title">Activity Feed</h3></div>
          <div class="c-card__body l-stack" style="--l-stack-gap: var(--pl-space-3);">
        ...
        <div class="c-card">
          <div class="c-card__header"><h3 class="c-card__title">Active Issues</h3></div>
...
<div class="l-container" style="padding-block: var(--pl-space-6);">
  <div class="l-sidebar" style="--l-sidebar-size: 16rem;">
    ...
    <form class="l-stack c-card" style="--l-stack-gap: var(--pl-space-6);">
      ...
      <div class="c-card__body l-stack" style="--l-stack-gap: var(--pl-space-4);">
        <label class="c-field">
          <span class="c-field__label">Full Name</span>
          <input class="c-field__control" type="text" value="Jane Doe" required />
        </label>
        
        <label class="c-field">
          <span class="c-field__label">Email Address</span>
          <input class="c-field__control" type="email" value="jane@example.com" required />
        </label>
      </div>

      <div class="c-card__footer l-cluster" style="--l-cluster-justify: flex-end;">
        <button class="c-button" type="button">Cancel</button>
        <button class="c-button" data-variant="primary" type="submit">Save</button>
      </div>
    </form>
  </div>
</div>
