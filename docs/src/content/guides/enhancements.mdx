...
<div class="pl-c-sticky-shell">
  <header class="pl-c-sticky-shell__bar">Sticky bar</header>
  <!-- scrolling content -->
</div>
```

Wrap any scroll region in `.pl-c-sticky-shell` and place the sticky element in
`.pl-c-sticky-shell__bar`. When the bar becomes stuck, it gains `box-shadow-2`
