...
>
  ...
  >
    <div class="pl-c-command__group">
      <h3 class="pl-c-command__heading">Actions</h3>
      <button
...
Keep focus on `.pl-c-command__search` while arrow keys move the active command.
...
| `.pl-c-command__group`    | Named group of actions.                           |
| `.pl-c-command__heading`  | Group label (uppercase, muted).                   |
| `.pl-c-command__item`     | An action button.                                 |
