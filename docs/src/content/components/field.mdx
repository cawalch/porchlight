...
<div class="c-field">
  ...
  <div class="c-input-group">
    <input id="workspace-slug" class="c-field__control" placeholder="acme-ops" />
    <span class="c-input-group__addon">.porchlight.app</span>
  </div>
  <span class="c-field__hint">Use lowercase letters, numbers, and hyphens.</span>
</div>
```
...
```html
<label class="c-field c-field--inline">
  <span class="u-visually-hidden">Search accounts</span>
...
- **Invalidity:** uses `:user-invalid` (Baseline 2024) for HTML5 constraints and
  ...
  alone: the hint text also changes to `danger-text`.
