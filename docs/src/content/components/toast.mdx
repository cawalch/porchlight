...
The `.pl-c-toast` is a transient notification that slides in from the screen
...
```html
<div
  class="pl-c-toast-stack"
  data-placement="bottom-end"
  role="region"
  aria-label="Notifications"
>
  <div class="pl-c-toast" data-tone="success" data-visible role="status">
    <span class="pl-c-toast__icon"><svg>...</svg></span>
    <div class="pl-c-toast__content">
      <span class="pl-c-toast__title">Saved</span>
      <span class="pl-c-toast__body">Changes were saved.</span>
    </div>
    <button class="pl-c-toast__close" aria-label="Dismiss">x</button>
  </div>
</div>
```
...
`.pl-c-toast-stack` is fixed by default at the block-end / inline-end corner. Use
...
| Selector               | Role                                                                |
| ---------------------- | ------------------------------------------------------------------- |
| `.pl-c-toast-stack`    | Fixed container (corner placement).                                 |
| `.pl-c-toast`          | Individual toast notification.                                      |
| `.pl-c-toast__icon`    | Leading icon (tone-colored).                                        |
| `.pl-c-toast__content` | Title + body wrapper.                                               |
| `.pl-c-toast__title`   | Bold heading.                                                       |
| `.pl-c-toast__body`    | Supporting text (muted).                                            |
| `.pl-c-toast__close`   | Dismiss button.                                                     |
