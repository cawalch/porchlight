...
The `data-pl-density="dense"` tier is the fourth and tightest density level,
...
Set `data-pl-density="dense"` on a container — it cascades to all children:

```html
<div data-pl-density="dense">
...
- **Tight event table** — `data-pl-density="dense"` on `.pl-c-table-wrap` for
  minimal row padding
...
- **Truncated messages** — `.pl-u-truncate` on long event descriptions
...
```html
<body data-pl-density="dense">
  <!-- Everything is dense -->
  <dialog data-pl-density="comfortable">
