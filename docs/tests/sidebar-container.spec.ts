...
/**
 * .pl-l-sidebar container-query guard.
 *
 * .pl-l-sidebar does NOT declare container-type itself (an element can't query
...
test("sidebar stays two-column without a container ancestor", async ({
  ...
  // Bare .pl-l-sidebar in the open body (no container ancestor): default layout.
  const cols = await page.evaluate(() => {
    const el = document.createElement("div");
    el.className = "pl-l-sidebar";
